...
CREATE TABLE CASES (
    ...
    average_match_value REAL CHECK (average_match_value >= 0),
    average_match_singleton REAL CHECK (average_match_singleton >= 0),
    average_match_sequence REAL CHECK (average_match_sequence >= 0),
    average_match_mapping REAL CHECK (average_match_mapping >= 0),
    average_match_class REAL CHECK (average_match_class >= 0),
    average_match_star REAL CHECK (average_match_star >= 0),
    average_match_as REAL CHECK (average_match_as >= 0),
    average_match_or REAL CHECK (average_match_or >= 0),
