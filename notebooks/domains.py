...
STATEMENT_CATEGORY_VALUES = ['AssignmentStmt', 'If', 'Return', 'AsyncFor', 'For', 'ImportFrom', 'Import', 'AugmentedAssignment', 'Raise', 'Try', 'Assert', 'While', 'With', 'Break', 'Pass', 'AnnotatedAssignment', 'Continue', 'Delete', 'Global', 'Match', 'Nonlocal', 'AsyncWith', 'ExceptHandler', 'TypeAlias']
